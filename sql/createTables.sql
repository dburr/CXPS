...
CREATE TABLE IF NOT EXISTS `units` (
  ...
  `favorite_flag` bit(1) NOT NULL DEFAULT b'0',
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `unlock_random_live_muse` bit(1) NOT NULL DEFAULT b'0',
  `unlock_random_live_aqours` bit(1) NOT NULL DEFAULT b'0',
  `insert_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `user_unit_album` (
  ...
  `rank_max_flag` bit(1) NOT NULL DEFAULT b'0',
  `love_max_flag` bit(1) NOT NULL DEFAULT b'0',
  `rank_level_max_flag` bit(1) NOT NULL DEFAULT b'0',
  `all_max_flag` bit(1) NOT NULL DEFAULT b'0',
